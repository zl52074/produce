        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <c:if test="${sessionScope.user == null}">
                    <li class="active"><a href="${pageContext.request.contextPath}/user/toRegisterPage.do"><span class="glyphicon glyphicon-user"></span> 注册</a></li>
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
            <div class="col-md-12" style="padding-top: 30px;">
                ...
                <div class="page-header">
                    <font color="#00bfff" size="4">用户注册</font>
                    <font size="2">USER REGISTER</font>
                </div>

                <form id="defaultForm" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/user/save.do" >
