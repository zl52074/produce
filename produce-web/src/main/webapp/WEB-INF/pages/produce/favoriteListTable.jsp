...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/produce/favoriteListTable.js"></script>
...
<div style="width: 1400px; margin: 0 auto;padding-top: 15px">
    ...
    <c:if test="${sessionScope.user == null}">
        <div style="text-align: center">当前已退出登陆，请重新<a href="${pageContext.request.contextPath}/user/toLoginPage.do">登陆</a>后再查看此列表</div>
    </c:if>
    <c:if test="${sessionScope.user != null}">
